# engine-sensor 0.1.0 para Linux x86_64

O arquivo `engine-sensor-linux-x86_64` é o binário interno do verificador AI-first.

```text
chmod +x engine-sensor-linux-x86_64
./engine-sensor-linux-x86_64 --help
./engine-sensor-linux-x86_64 init /caminho/do/jogo
./engine-sensor-linux-x86_64 check /caminho/do/jogo
```
